...
build/kernel.bin: build/kernel.asm.o build/kernel.o build/gdt.o build/gdt.asm.o build/idt.o build/idt.asm.o build/hal.o build/memory.o build/heap.o build/paging.o build/paging.asm.o build/tss.o build/tss.asm.o build/disk.o build/console.o build/task.o build/process.o
	i686-elf-ld -relocatable $(LDFLAGS) build/kernel.asm.o build/kernel.o build/gdt.o build/gdt.asm.o build/idt.o build/idt.asm.o build/hal.o build/memory.o build/heap.o build/paging.o build/paging.asm.o build/tss.o build/tss.asm.o build/disk.o build/console.o build/task.o build/process.o -o build/kernel.tmp.o
