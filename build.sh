...
if [ "$1" == "build" ]; then
    ...
    clang src/*.c kernel.c -o kernel.bin -nostdlib -nodefaultlibs -fno-exceptions -fno-asynchronous-unwind-tables -Wl,--build-id=none -Wl,--no-dynamic-linker -Wl,-z,norelro -Weverything -Wno-declaration-after-statement -Wno-unsafe-buffer-usage -Wno-incompatible-library-redeclaration
